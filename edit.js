...
function sendjsondata() {
    ...
    if (saved.success) {
        ...
        document.getElementById("poststatus").innerHTML = 'The information has been successfully saved!  <a href="#" onclick="hidestatus()"><u><b>X</b></u></a>';
    ...
    if (!saved.success) {
        document.getElementById("poststatusdiv").hidden = false;
        document.getElementById("poststatus").innerHTML = 'An ERROR has occurred, please try again!!!  <a href="#" onclick="hidestatus()"><u><b>X</b></u></a>';
